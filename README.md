...
**STUDAC** is an AI-powered EdTech SaaS transforming how schools manage academic operations.  
It streamlines:
- **Timetable Generation** with constraint-satisfying optimization,
- **Automated Grading** using ML models trained on real-world exam datasets,
- **AI Tutoring** via LLMs and prompt engineering for personalized learning.  

Built with:
- Python, Pandas, Seaborn, LLM APIs  
- Modular architecture for extensibility across institutions and curricula  

> STUDAC is more than a tool — it's a foundation for intelligent, scalable academic systems.
